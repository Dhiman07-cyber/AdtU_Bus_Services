                ...
                <div>
                  ...
                  {hasShiftConflict && (
                    <div className="text-[10px] text-red-500 mt-2 bg-red-500/10 border border-red-500/20 p-2 rounded flex items-start gap-1.5 leading-relaxed">
                      ...
                      <span>
                        The assigned bus ({formData.busAssigned}) does not operate in the {formData.shift} shift. Please use the <Link href="/moderator/smart-allocation" className="underline hover:text-red-400">Student Reassignment</Link> portal to change shift and bus together, or revert the shift.
                      </span>
                    </div>
                  )}
                </div>
