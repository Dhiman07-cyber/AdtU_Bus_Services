    ...
    <div className="min-h-screen pb-12 mt-8 bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <main className="max-w-7xl mx-auto px-4 py-4">
            ...
            <div className="md:sticky md:top-6">
              ...
              <div className="md:hidden mt-6 flex justify-center">
                {(() => {
                  ...
                  const displayStatus = isExpired ? 'inactive' : (student.status || 'active');
          ...
          <div className="p-4">
            <div className="grid md:grid-cols-2 gap-x-6 gap-y-2">
              <div className="flex justify-between py-1.5 border-b border-border">
                ...
                <span className="text-foreground font-semibold text-xs">{student.fullName || student.name}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-border">
                <span className="text-muted-foreground font-medium text-xs">Date of Birth</span>
                <span className="text-foreground font-semibold text-xs">{formatDate(student.dob)}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-border">
                <span className="text-muted-foreground font-medium text-xs">Email</span>
                <span className="text-foreground font-semibold truncate max-w-xs text-xs">{student.email}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-border">
                <span className="text-muted-foreground font-medium text-xs">Phone</span>
                <span className="text-foreground font-semibold text-xs">{student.phoneNumber || 'Not Available'}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-border">
                <span className="text-muted-foreground font-medium text-xs">Alternate Phone</span>
                <span className="text-foreground font-semibold text-xs">{student.alternatePhone || 'Not Available'}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-border">
                <span className="text-muted-foreground font-medium text-xs">Address</span>
                <span className="text-foreground font-semibold text-right text-xs">{student.address || 'Not Available'}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            <div className="divide-y divide-border">
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Enrollment ID</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">{student.enrollmentId || 'Not provided'}</span>
              </div>
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Faculty</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">{student.faculty || 'Not provided'}</span>
              </div>
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Department</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">{student.department || 'Not provided'}</span>
              </div>
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Semester</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">{student.semester || 'Not provided'}</span>
              </div>
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Session Period</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">
                  {student.sessionStartYear && student.sessionEndYear ? `${student.sessionStartYear} - ${student.sessionEndYear}` : 'Not provided'}
                </span>
              </div>
              <div className="grid md:grid-cols-3 gap-3 px-4 py-2 hover:bg-muted/30 transition-colors">
                <span className="text-muted-foreground font-medium text-xs">Valid Until</span>
                <span className="md:col-span-2 text-foreground font-semibold text-xs">
        ...
        <div className="mb-5 grid lg:grid-cols-2 gap-4">
          ...
          <div className="overflow-hidden rounded-lg bg-gradient-to-br from-card via-orange-50/10 to-card dark:from-card dark:via-orange-950/10 dark:to-card border border-orange-200/40 dark:border-orange-800/30 shadow-md hover:shadow-lg transition-all">
            <div className="bg-gradient-to-r from-orange-100/60 via-orange-200/40 to-orange-100/60 dark:from-orange-900/30 dark:via-orange-800/20 dark:to-orange-900/30 px-3 py-2 border-b border-border/50">
              <div className="flex items-center gap-2">
                <div className="p-1 rounded-lg bg-orange-100 dark:bg-orange-900/50">
                  <Heart className="w-3 h-3 text-orange-700 dark:text-orange-400" />
                </div>
                <h3 className="text-xs font-bold text-foreground">Guardian Contact</h3>
              </div>
            </div>
            <div className="p-3">
              <div className="space-y-1.5">
                <div>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-wide mb-0.5">Parent Name</p>
                  <p className="text-xs font-bold text-foreground">{student.parentName || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-wide mb-0.5">Parent Phone</p>
                  <p className="text-xs font-bold text-foreground">{student.parentPhone || 'Not provided'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-lg bg-gradient-to-br from-card via-green-50/10 to-card dark:from-card dark:via-green-950/10 dark:to-card border border-green-200/40 dark:border-green-800/30 shadow-md hover:shadow-lg transition-all">
            <div className="bg-gradient-to-r from-green-100/60 via-green-200/40 to-green-100/60 dark:from-green-900/30 dark:via-green-800/20 dark:to-green-900/30 px-3 py-2 border-b border-border/50">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-bold text-foreground">Transportation</h3>
              </div>
            </div>
            <div className="p-3">
              <div className="space-y-1.5">
                <div className="flex justify-between">
                  ...
                  <span className="text-xs font-bold text-foreground">{formatId(student.routeId)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-xs text-muted-foreground">Bus</span>
                  <span className="text-xs font-bold text-foreground">{formatId(student.busId)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-xs text-muted-foreground">Pickup Point</span>
                  <span className="text-xs font-bold text-foreground text-right">{student.stopId.replace(student.stopId, student.stopId.charAt(0).toUpperCase() + student.stopId.slice(1)) || 'Not Assigned'}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-6 overflow-hidden rounded-xl border border-emerald-500/20 dark:border-emerald-500/10 bg-[#020817] shadow-2xl transition-all duration-300">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-muted/30">
                    <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider border-b border-border w-12 text-center whitespace-nowrap md:px-6">Sl. No</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Session</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Type</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Amount</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Date</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Approved By</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border whitespace-nowrap md:px-6 md:border-l md:border-border/30">Status</th>
                    <th className="px-4 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border text-right whitespace-nowrap md:px-6 md:border-l md:border-border/30">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {payments.map((payment, idx) => (
                    <tr key={payment.paymentId || payment.id || idx} className="hover:bg-muted/30 transition-colors border-b border-border/10">
                      <td className="px-4 py-4 whitespace-nowrap text-center text-xs font-bold text-muted-foreground md:px-6">
                        {String(idx + 1).padStart(2, '0')}
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap md:px-6 md:border-l md:border-border/30">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap md:px-6 md:border-l md:border-border/30">
                        ...
                        {((payment.paymentMethod || payment.method)?.toLowerCase() !== 'online') && (
                          <div className="text-[10px] text-muted-foreground font-medium">
                            {payment.approvedBy?.role?.toLowerCase() === 'admin'
                              ? 'Administrator'
                              : `Emp ID: ${payment.approvedBy?.empId || 'N/A'}`}
                          </div>
                        )}
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap md:px-6 md:border-l md:border-border/30">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-right md:px-6 md:border-l md:border-border/30">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleDownloadReceipt(payment.paymentId || payment.id)}
                          className="h-8 gap-1.5 text-[10px] font-bold text-blue-400 hover:text-blue-300 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 px-3 transition-all"
                        >
