...
export default function ViewBusPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleEdit = () => {
    router.push(`/admin/buses/edit/${id}`);
  };
    ...
    return (
      <div className="mt-15 min-h-screen flex items-center justify-center bg-[#010717]">
        <div className="text-center">
          ...
          <Link href="/admin/buses" className="text-purple-400 hover:text-purple-300 mt-4 inline-block">
            ← Back to Buses
          </Link>
        </div>
      </div>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4 min-w-0">
                  ...
                  <div className="flex items-center space-x-4 w-full sm:w-auto">
                    <div className="relative flex-shrink-0">
                      <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg border-2 border-blue-400/30">
