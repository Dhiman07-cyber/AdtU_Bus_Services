...
exports.raiseWaitingFlag = raiseWaitingFlag;
...
function getOfflineRouteById(routeId) {
    try {
        // Import the JSON data directly
        const busRoutesData = require('../../src/data/BusRoutes.json');
        const route = busRoutesData.find((r) => `route-${r.id}` === routeId);
        if (route) {
            return {
                id: route.id,
...
async function raiseWaitingFlag(req, res) {
    var _a, _b;
    try {
        const { busId, routeId, stopName, stopId, lat, lng } = req.body;
        const studentUid = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        ...
        if ((studentData === null || studentData === void 0 ? void 0 : studentData.busId) !== busId) {
        ...
        if (lat && lng && stopId) {
            ...
            if (routeDoc.exists) {
                ...
                const stop = (_b = routeData === null || routeData === void 0 ? void 0 : routeData.stops) === null || _b === void 0 ? void 0 : _b.find((s) => s.stopId === stopId);
                if (stop) {
        ...
        try {
            ...
            const driverUid = busData === null || busData === void 0 ? void 0 : busData.driverUID;
            if (driverUid) {
