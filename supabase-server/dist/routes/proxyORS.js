...
async function proxyORS(req, res) {
    ...
    try {
        ...
        if (routeStops && Array.isArray(routeStops)) {
            coordsToUse = routeStops.map((stop) => ({
                lat: stop.lat,
                lng: stop.lng
            }));
        }
        ...
        if (!orsApiKey) {
            ...
            return res.json(Object.assign(Object.assign({}, approximateResult), { approximate: true }));
        }
        ...
        if (!response.ok) {
            ...
            const approximateResult = calculateApproximateETA(coordsToUse);
            cache.set(cacheKey, approximateResult);
            return res.json(Object.assign(Object.assign({}, approximateResult), { approximate: true, fallback: true }));
        }
        ...
        if (data.features && data.features.length > 0) {
            ...
            result = {
                ...
                distance: ((_a = properties === null || properties === void 0 ? void 0 : properties.summary) === null || _a === void 0 ? void 0 : _a.distance) || 0,
                duration: ((_b = properties === null || properties === void 0 ? void 0 : properties.summary) === null || _b === void 0 ? void 0 : _b.duration) || 0,
            };
        }
        if (result) {
            // Cache the result
...
function calculateApproximateETA(coordinates) {
    ...
    const straightLineCoords = coordinates.map(coord => [coord.lng, coord.lat]);
    return {
