...
const { startJourney } = require('./routes/startJourney');
const { updateLocation } = require('./routes/updateLocation');
const { raiseWaitingFlag } = require('./routes/raiseFlag');
const { ackWaitingFlag } = require('./routes/ackFlag');
const { markAttendance } = require('./routes/markAttendance');
const { endJourney } = require('./routes/endJourney');
const { proxyORS } = require('./routes/proxyORS');
const { startCleanupJob } = require('./jobs/cleanupWaitingFlags');
...
// Get Bus Locations
app.get('/api/bus-locations/:busId?', async (req, res) => {
  try {
...
// Get Waiting Flags
app.get('/api/waiting-flags/:busId?', async (req, res) => {
  try {
    const { busId } = req.params;
...
// Get Driver Status
app.get('/api/driver-status/:driverUid?', async (req, res) => {
  try {
...
// Proxy ORS endpoint
app.post('/api/proxy-ors', proxyORS);
